...
```{r ralapkorny-01, fig.align='center', echo=FALSE, out.width='85%', fig.link='', fig.cap="Az R környezet: Alap R és az egyéb csomagok"}
...
`r if (knitr:::is_html_output()) fontawesome::fa("check-double", fill = "forestgreen")` `r if (knitr:::is_html_output())'[ A fenti feladatok megoldása](#mi-az-r-1-exercise-solution)'`
...
`r if (knitr:::is_html_output()) fontawesome::fa("check-double", fill = "forestgreen")` `r if (knitr:::is_html_output()) '[ A fenti feladatok megoldása](#mi-az-r-2-exercise-solution)'`
...
`r if (knitr:::is_html_output()) fontawesome::fa("check-double", fill = "forestgreen")` `r if (knitr:::is_html_output()) '[ A fenti feladatok megoldása](#mi-az-r-3-exercise-solution)'`
