...
```{r alaprst03, fig.align='center', echo=FALSE, out.width='85%', fig.link='', fig.cap="Az R kényelmes használata"}
...
```{r rstudio-01, fig.align='center', echo=FALSE, out.width='85%', fig.link='', fig.cap="Az RStudio tipikus képernyőképe"}
...
```{r rstudio-utf8, fig.align='center', echo=FALSE, out.width='70%', fig.link='', fig.cap="Az UTF-8 beállítása az RStudio-ban"}
...
```{r rstudio-rdata, fig.align='center', echo=FALSE, out.width='70%', fig.link='', fig.cap="A munkaterület automatikus mentésének tiltása az RStudio-ban"}
...
```{r rstudio-inline, fig.align='center', echo=FALSE, out.width='70%', fig.link='', fig.cap="Az output megjelenítésének tiltása az RMarkdown lapon"}
...
`r import_example('pelda_RMarkdown1.Rmd')`
...
```{r rstudio-proj-2, fig.align='center', echo=FALSE, out.width='65%', fig.link='', fig.cap="RStudio projekt létrehozása: 2. lépés"}
...
```{r rstudio-proj-3, fig.align='center', echo=FALSE, out.width='65%', fig.link='', fig.cap="RStudio projekt létrehozása: 3. lépés"}
...
```{r rstudio-proj-4, fig.align='center', echo=FALSE, out.width='65%', fig.link='', fig.cap="RStudio projekt létrehozása: létező könyvtár megadása"}
...
`r if (knitr:::is_html_output()) fontawesome::fa("check-double", fill = "forestgreen")`  `r if (knitr:::is_html_output()) '[A fenti feladatok megoldása](#munka-az-r-ben-1-exercise-solution)'`
...
Az *RStudio* a parancsok gépelését számos módon könnyíti meg, de ha egy függvényről részletesebb leírást  szeretnénk olvasni, akkor a `?függvénynév` parancsot használjuk. Egy-egy témakör gyors megismeréséhez a cheet-sheet-eket ajánljuk, amelyek az *RStudio* `Help / Cheetsheets` menüjéből is elérhetők. Az R hivatalos honlapján hosszabb leírásokat is találunk.   
...
`r if (knitr:::is_html_output()) fontawesome::fa("check-double", fill = "forestgreen")`  `r if (knitr:::is_html_output()) '[A fenti feladatok megoldása](#munka-az-r-ben-2-exercise-solution)'`
...
```{r konzol-win, fig.align='center', echo=FALSE, out.width='70%', fig.link='', fig.cap="RGui alkalmazás a konzollal Windows környezetben"}
...
```{r rcommander-1, fig.align='center', echo=FALSE, out.width='85%', fig.link='', fig.cap="Az R Commander induló ablaka"}
...
`r if (knitr:::is_html_output()) fontawesome::fa("check-double", fill = "forestgreen")`  `r if (knitr:::is_html_output()) '[A fenti feladatok megoldása](#munka-az-r-ben-3-exercise-solution)'`
