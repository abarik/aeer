...
`r if (knitr:::is_html_output()) fontawesome::fa("check-double", fill = "forestgreen")`  `r if (knitr:::is_html_output()) '[ A fenti feladatok megoldása](#itt-kezdodik-1-exercise-solution)'`
...
`r if (knitr:::is_html_output()) fontawesome::fa("check-double", fill = "forestgreen")` `r if (knitr:::is_html_output()) '[ A fenti feladatok megoldása](#itt-kezdodik-2-exercise-solution)'`
...
`r if (knitr:::is_html_output()) fontawesome::fa("check-double", fill = "forestgreen")` `r if (knitr:::is_html_output()) '[ A fenti feladatok megoldása](#itt-kezdodik-3-exercise-solution)'`
