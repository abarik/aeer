...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-8-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-9-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-9-2} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-9-3} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-9-4} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-9-5} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-9-6} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-9-7} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-9-8} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-9-9} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-10-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-11-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-12-1} \end{center}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.5098}}@{}}
\toprule
\begin{minipage}[b]{\linewidth}\raggedright
Ábraelem
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# egyezes \textless{}{-} d.tbl$platform}
\CommentTok{\# tbl \textless{}{-} data.frame(egyezes=egyezes)}
\CommentTok{\# ggplot(tbl, aes(x=egyezes, group=1)) + geom\_bar(aes(y = ..count..)) +}
\CommentTok{\#   geom\_text(aes( label = scales::percent(..prop..), y= ..prop.. ), stat= "count",  vjust = {-}.5) +}
\CommentTok{\#   scale\_y\_continuous(labels = scales::percent) +}
\CommentTok{\#   coord\_cartesian(ylim = c(0, 1101)) + labs(x="Egyező gének száma", y="Előfordulás")}
\CommentTok{\# }
\CommentTok{\# }
\CommentTok{\# ggplot(d.tbl, aes(x=factor(platform), y=user\_score)) + geom\_boxplot() +}
\CommentTok{\#   geom\_text(aes(label = scales::percent(..lower..)), stat= "boxplot",  vjust = {-}.5) }
...
\NormalTok{df}\SpecialCharTok{$}\NormalTok{cyl }\OtherTok{\textless{}{-}} \FunctionTok{as.factor}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{cyl)}
\FunctionTok{head}\NormalTok{(df[, }\FunctionTok{c}\NormalTok{(}\StringTok{"wt"}\NormalTok{, }\StringTok{"mpg"}\NormalTok{, }\StringTok{"cyl"}\NormalTok{)], }\DecValTok{3}\NormalTok{)}
\CommentTok{\#\textgreater{}                  wt  mpg cyl}
\CommentTok{\#\textgreater{} Mazda RX4     2.620 21.0   6}
\CommentTok{\#\textgreater{} Mazda RX4 Wag 2.875 21.0   6}
\CommentTok{\#\textgreater{} Datsun 710    2.320 22.8   4}
...
\NormalTok{df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
 \AttributeTok{group =} \FunctionTok{c}\NormalTok{(}\StringTok{"Male"}\NormalTok{, }\StringTok{"Female"}\NormalTok{, }\StringTok{"Child"}\NormalTok{),}
  \AttributeTok{value =} \FunctionTok{c}\NormalTok{(}\DecValTok{25}\NormalTok{, }\DecValTok{25}\NormalTok{, }\DecValTok{50}\NormalTok{))}

\FunctionTok{head}\NormalTok{(df)}
\CommentTok{\#\textgreater{}    group value}
\CommentTok{\#\textgreater{} 1   Male    25}
\CommentTok{\#\textgreater{} 2 Female    25}
\CommentTok{\#\textgreater{} 3  Child    50}


\CommentTok{\# Basic pie charts}
\CommentTok{\# ++++++++++++++++++++++++++++++++}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-13-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-13-2} \end{center}

\begin{Shaded}
\begin{Highlighting}[]


\CommentTok{\# Change label}
\CommentTok{\# ++++++++++++++++++++++++++++++++}

\CommentTok{\# Show group names and value as labels}
\NormalTok{labs }\OtherTok{\textless{}{-}} \FunctionTok{paste0}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{group, }\StringTok{" ("}\NormalTok{, df}\SpecialCharTok{$}\NormalTok{value, }\StringTok{"\%)"}\NormalTok{)}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-13-3} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-13-4} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-16-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-17-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-18-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-19-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-19-2} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-19-3} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-19-4} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-19-5} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-20-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-22-1} \end{center}
...
\CommentTok{\# p1 {-} hisztogram és gyakorisági poligon}
\NormalTok{p1 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{survey, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Height)) }\SpecialCharTok{+} 
        \FunctionTok{geom\_histogram}\NormalTok{(}\AttributeTok{colour =} \StringTok{"blue"}\NormalTok{, }\AttributeTok{fill =} \StringTok{"white"}\NormalTok{, }\AttributeTok{binwidth=}\DecValTok{4}\NormalTok{) }\SpecialCharTok{+} 
        \FunctionTok{geom\_freqpoly}\NormalTok{(}\AttributeTok{binwidth =} \DecValTok{4}\NormalTok{, }\AttributeTok{size=}\DecValTok{1}\NormalTok{, }\AttributeTok{colour=}\StringTok{"blue"}\NormalTok{)}

\CommentTok{\# p2 {-} hisztogram és a normális eloszlás sűrűségfüggvénye}
\NormalTok{p2 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{survey, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Height)) }\SpecialCharTok{+} 
        \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ ..density..), }\AttributeTok{colour=}\StringTok{"blue"}\NormalTok{, }\AttributeTok{fill=}\StringTok{"white"}\NormalTok{, }\AttributeTok{binwidth=}\DecValTok{4}\NormalTok{) }\SpecialCharTok{+} 
        \FunctionTok{stat\_function}\NormalTok{(}\AttributeTok{fun=}\NormalTok{dnorm, }\AttributeTok{args =} \FunctionTok{list}\NormalTok{(}\AttributeTok{mean=}\FunctionTok{mean}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Height, }\AttributeTok{na.rm=}\NormalTok{T),}
                                             \AttributeTok{sd=}\FunctionTok{sd}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Height, }\AttributeTok{na.rm =}\NormalTok{ T)), }
                      \AttributeTok{colour=}\StringTok{"red"}\NormalTok{, }\AttributeTok{size=}\DecValTok{1}\NormalTok{)}

\CommentTok{\# p3 {-} simított hisztogram és a normális eloszlás sűrűségfüggvénye}
\NormalTok{p3 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{survey, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Height)) }\SpecialCharTok{+} 
        \FunctionTok{geom\_density}\NormalTok{(}\AttributeTok{colour=}\StringTok{"blue"}\NormalTok{) }\SpecialCharTok{+} 
        \FunctionTok{stat\_function}\NormalTok{(}\AttributeTok{fun=}\NormalTok{dnorm, }\AttributeTok{args =} \FunctionTok{list}\NormalTok{(}\AttributeTok{mean=}\FunctionTok{mean}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Height, }\AttributeTok{na.rm=}\NormalTok{T),}
                                             \AttributeTok{sd=}\FunctionTok{sd}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Height, }\AttributeTok{na.rm =}\NormalTok{ T)), }
                      \AttributeTok{colour=}\StringTok{"red"}\NormalTok{, }\AttributeTok{size=}\DecValTok{1}\NormalTok{)}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-23-1} \end{center}
...
\CommentTok{\# p1 {-} hisztogramok egymás alá}
\NormalTok{p1 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{survey[}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Exer),], }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Height)) }\SpecialCharTok{+} 
        \FunctionTok{geom\_histogram}\NormalTok{(}\AttributeTok{colour =} \StringTok{"blue"}\NormalTok{, }\AttributeTok{fill =} \StringTok{"white"}\NormalTok{, }\AttributeTok{binwidth=}\DecValTok{4}\NormalTok{) }\SpecialCharTok{+} 
        \FunctionTok{facet\_wrap}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{ Exer, }\AttributeTok{nrow =} \DecValTok{3}\NormalTok{)}

\CommentTok{\# p2 {-} hisztogramok táblázatszerűen}
\NormalTok{p2 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{survey[}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Exer),], }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Height)) }\SpecialCharTok{+} 
        \FunctionTok{geom\_histogram}\NormalTok{(}\AttributeTok{colour =} \StringTok{"blue"}\NormalTok{, }\AttributeTok{fill =} \StringTok{"white"}\NormalTok{, }\AttributeTok{binwidth=}\DecValTok{4}\NormalTok{) }\SpecialCharTok{+} 
        \FunctionTok{facet\_wrap}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{ Exer, }\AttributeTok{nrow =} \DecValTok{2}\NormalTok{)}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-24-1} \end{center}

\hypertarget{gyakorisuxe1gi-poligon-uxe9s-simuxedtott-hisztogram-csoportokra-de-egy-uxe1bruxe1n}{%
\subsection{Gyakorisági poligon és simított hisztogram csoportokra, de egy ábrán}\label{gyakorisuxe1gi-poligon-uxe9s-simuxedtott-hisztogram-csoportokra-de-egy-uxe1bruxe1n}}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{data}\NormalTok{(survey, }\AttributeTok{package =} \StringTok{"MASS"}\NormalTok{) }\CommentTok{\# a survey beolvasása}

\CommentTok{\# p1 {-} gyakorisági poligonok egy ábrán}
\NormalTok{p1 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{survey[}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Exer),], }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Height, }\AttributeTok{y=}\NormalTok{..density.., }\AttributeTok{colour =}\NormalTok{ Exer)) }\SpecialCharTok{+} 
        \FunctionTok{geom\_freqpoly}\NormalTok{(}\AttributeTok{binwidth =} \DecValTok{4}\NormalTok{, }\AttributeTok{size=}\FloatTok{0.7}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position=}\StringTok{"top"}\NormalTok{)}

\CommentTok{\# p2 {-} simított hisztogramok egy ábrán}
\NormalTok{p2 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{survey, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Height, }\AttributeTok{colour =}\NormalTok{ Exer)) }\SpecialCharTok{+} \FunctionTok{geom\_density}\NormalTok{(}\AttributeTok{size=}\FloatTok{0.7}\NormalTok{) }\SpecialCharTok{+}
        \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position=}\StringTok{"top"}\NormalTok{)}

\CommentTok{\# p3 {-} simított hisztogram kitöltéssel egy ábrán}
\NormalTok{p3 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{survey, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Height, }\AttributeTok{fill =}\NormalTok{ Exer)) }\SpecialCharTok{+} \FunctionTok{geom\_density}\NormalTok{(}\AttributeTok{alpha=}\FloatTok{0.2}\NormalTok{, }\AttributeTok{size=}\FloatTok{0.7}\NormalTok{) }\SpecialCharTok{+} 
        \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position=}\StringTok{"top"}\NormalTok{)}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-25-1} \end{center}
...
\CommentTok{\# p1 {-} dobozdiagram a Smoke csoportjaira}
\NormalTok{p1 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{survey[}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Smoke),], }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Smoke, }\AttributeTok{y=}\NormalTok{Pulse, }\AttributeTok{fill=}\NormalTok{Smoke)) }\SpecialCharTok{+} 
...
\CommentTok{\# p2 {-} dobozdiagram a Smoke csoportjaira a Sex figyelembevételével}
\NormalTok{p2 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{survey[}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Smoke) }\SpecialCharTok{\&} \SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Sex),], }
             \FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Smoke, }\AttributeTok{y=}\NormalTok{Pulse, }\AttributeTok{fill=}\NormalTok{Smoke)) }\SpecialCharTok{+} 
        \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{guides}\NormalTok{(}\AttributeTok{fill=}\ConstantTok{FALSE}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{facet\_wrap}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{ Sex, }\AttributeTok{nrow =} \DecValTok{1}\NormalTok{)}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-26-1} \end{center}
...
\CommentTok{\# p1 {-} oszlopdiagram az átlagokra 95\%{-}os konfidencia intervallummal I.}
\NormalTok{p1 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{survey[}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Smoke),], }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Smoke, }\AttributeTok{y=}\NormalTok{Pulse)) }\SpecialCharTok{+} 
        \FunctionTok{stat\_summary}\NormalTok{(}\AttributeTok{fun.y=}\NormalTok{mean, }\AttributeTok{geom=}\StringTok{"bar"}\NormalTok{, }\AttributeTok{fill=}\StringTok{"white"}\NormalTok{, }\AttributeTok{colour=}\StringTok{"black"}\NormalTok{) }\SpecialCharTok{+} 
        \FunctionTok{stat\_summary}\NormalTok{(}\AttributeTok{fun.data=}\NormalTok{mean\_cl\_normal, }\AttributeTok{geom=}\StringTok{"pointrange"}\NormalTok{) }\SpecialCharTok{+}
...
\CommentTok{\# p2 {-} oszlopdiagram az átlagokra 95\%{-}os konfidencia intervallummal II.}
\NormalTok{p2 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{survey[}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Smoke),], }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Smoke, }\AttributeTok{y=}\NormalTok{Pulse)) }\SpecialCharTok{+} 
        \FunctionTok{stat\_summary}\NormalTok{(}\AttributeTok{fun.y=}\NormalTok{mean, }\AttributeTok{geom=}\StringTok{"bar"}\NormalTok{, }\AttributeTok{fill=}\StringTok{"\#95b0ff"}\NormalTok{, }\AttributeTok{colour=}\StringTok{"black"}\NormalTok{) }\SpecialCharTok{+} 
...
\CommentTok{\# p3 {-} vonaldiagram az átlagokra 95\%{-}os konfidencia intervallummal}
\NormalTok{p3 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{survey[}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Smoke),], }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Smoke, }\AttributeTok{y=}\NormalTok{Pulse)) }\SpecialCharTok{+} 
        \FunctionTok{stat\_summary}\NormalTok{(}\AttributeTok{fun.y=}\NormalTok{mean, }\AttributeTok{geom=}\StringTok{"point"}\NormalTok{) }\SpecialCharTok{+} 
        \FunctionTok{stat\_summary}\NormalTok{(}\AttributeTok{fun.y=}\NormalTok{mean, }\AttributeTok{geom=}\StringTok{"line"}\NormalTok{, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{group=}\DecValTok{1}\NormalTok{), }\AttributeTok{colour=}\StringTok{"blue"}\NormalTok{, }\AttributeTok{linetype=}\StringTok{"dashed"}\NormalTok{) }\SpecialCharTok{+} 
        \FunctionTok{stat\_summary}\NormalTok{(}\AttributeTok{fun.data=}\NormalTok{mean\_cl\_normal, }\AttributeTok{geom=}\StringTok{"errorbar"}\NormalTok{, }\AttributeTok{width=}\FloatTok{0.2}\NormalTok{) }\SpecialCharTok{+}
        \FunctionTok{coord\_cartesian}\NormalTok{(}\AttributeTok{ylim =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{100}\NormalTok{)) }
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-27-1} \end{center}

\hypertarget{uxe1tlagok-kuxe9t-faktor-esetuxe9n}{%
\subsection{Átlagok két faktor esetén}\label{uxe1tlagok-kuxe9t-faktor-esetuxe9n}}
...
\CommentTok{\# p1 {-} oszlopdiagram az átlagokra 95\%{-}os konfidencia intervallummal I.}
\NormalTok{p1 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{survey[}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Exer) }\SpecialCharTok{\&} \SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Sex),], }
             \FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Exer, }\AttributeTok{y=}\NormalTok{Pulse, }\AttributeTok{fill=}\NormalTok{Sex)) }\SpecialCharTok{+} 
        \FunctionTok{stat\_summary}\NormalTok{(}\AttributeTok{fun.y=}\NormalTok{mean, }\AttributeTok{geom=}\StringTok{"bar"}\NormalTok{, }\AttributeTok{position=}\StringTok{"dodge"}\NormalTok{, }\AttributeTok{colour=}\StringTok{"black"}\NormalTok{) }\SpecialCharTok{+} 
        \FunctionTok{stat\_summary}\NormalTok{(}\AttributeTok{fun.data=}\NormalTok{mean\_cl\_normal, }\AttributeTok{geom=}\StringTok{"errorbar"}\NormalTok{, }
                     \AttributeTok{position=}\FunctionTok{position\_dodge}\NormalTok{(}\AttributeTok{width=}\FloatTok{0.90}\NormalTok{), }\AttributeTok{width=}\FloatTok{0.2}\NormalTok{) }\SpecialCharTok{+}
        \FunctionTok{scale\_fill\_manual}\NormalTok{(}\StringTok{"Sex"}\NormalTok{,}\AttributeTok{values =} \FunctionTok{c}\NormalTok{(}\StringTok{"Female"}\OtherTok{=}\StringTok{"\#bccdff"}\NormalTok{, }\StringTok{"Male"}\OtherTok{=}\StringTok{"\#81a1ff"}\NormalTok{)) }\SpecialCharTok{+} 
        \FunctionTok{coord\_cartesian}\NormalTok{(}\AttributeTok{ylim =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{100}\NormalTok{)) }\SpecialCharTok{+} \FunctionTok{theme\_bw}\NormalTok{() }\SpecialCharTok{+} 
        \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.justification=}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{),}\AttributeTok{legend.position=}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{),  }
              \AttributeTok{legend.direction=}\StringTok{"horizontal"}\NormalTok{)  }

\CommentTok{\# p2 {-} oszlopdiagram az átlagokra 95\%{-}os konfidencia intervallummal II.}
\NormalTok{p2 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{survey[}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Exer) }\SpecialCharTok{\&} \SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Sex),], }
             \FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Exer, }\AttributeTok{y=}\NormalTok{Pulse)) }\SpecialCharTok{+} 
        \FunctionTok{stat\_summary}\NormalTok{(}\AttributeTok{fun.y=}\NormalTok{mean, }\AttributeTok{geom=}\StringTok{"bar"}\NormalTok{, }\AttributeTok{fill=}\StringTok{"\#95b0ff"}\NormalTok{, }\AttributeTok{colour=}\StringTok{"black"}\NormalTok{) }\SpecialCharTok{+} 
        \FunctionTok{stat\_summary}\NormalTok{(}\AttributeTok{fun.data=}\NormalTok{mean\_cl\_normal, }\AttributeTok{geom=}\StringTok{"errorbar"}\NormalTok{, }\AttributeTok{width=}\FloatTok{0.2}\NormalTok{) }\SpecialCharTok{+}
        ...
        \FunctionTok{facet\_wrap}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{ Sex, }\AttributeTok{nrow =} \DecValTok{1}\NormalTok{)}

\CommentTok{\# p3 {-} vonaldiagram az átlagokra 95\%{-}os konfidencia intervallummal}
\NormalTok{p3 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{survey[}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Exer) }\SpecialCharTok{\&} \SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{Sex),], }
             \FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Exer, }\AttributeTok{y=}\NormalTok{Pulse, }\AttributeTok{colour=}\NormalTok{Sex)) }\SpecialCharTok{+} 
        \FunctionTok{stat\_summary}\NormalTok{(}\AttributeTok{fun.y=}\NormalTok{mean, }\AttributeTok{geom=}\StringTok{"point"}\NormalTok{, }\AttributeTok{size=}\DecValTok{3}\NormalTok{, }\AttributeTok{shape=}\DecValTok{21}\NormalTok{, }\AttributeTok{fill=}\StringTok{"white"}\NormalTok{) }\SpecialCharTok{+} 
        \FunctionTok{stat\_summary}\NormalTok{(}\AttributeTok{fun.data=}\NormalTok{mean\_cl\_normal, }\AttributeTok{geom=}\StringTok{"line"}\NormalTok{, }\AttributeTok{size=}\DecValTok{1}\NormalTok{, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{group=}\NormalTok{Sex)) }\SpecialCharTok{+}
        \FunctionTok{stat\_summary}\NormalTok{(}\AttributeTok{fun.data=}\NormalTok{mean\_cl\_normal, }\AttributeTok{geom=}\StringTok{"errorbar"}\NormalTok{, }\AttributeTok{size=}\DecValTok{1}\NormalTok{, }\AttributeTok{width=}\FloatTok{0.1}\NormalTok{) }\SpecialCharTok{+}
        \FunctionTok{coord\_cartesian}\NormalTok{(}\AttributeTok{ylim =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{100}\NormalTok{)) }\SpecialCharTok{+} 
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-28-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-29-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{09-Grafika_files/figure-latex/unnamed-chunk-30-1} \end{center}

\hypertarget{feladatok}{%
\section{Feladatok}\label{feladatok}}
...
\tightlist
\item
  Készítsük el a következő 4 ábrát a hagyományos grafikában a \textbf{MASS} csomag \texttt{survey} adatbázisa alapján: \includegraphics{b001_abra.png}
  \end{rmdexercise}
\end{enumerate}
